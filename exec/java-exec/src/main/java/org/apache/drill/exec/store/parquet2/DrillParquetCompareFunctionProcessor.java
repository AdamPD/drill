...
public class DrillParquetCompareFunctionProcessor extends
    ...
    public static DrillParquetCompareFunctionProcessor process(FunctionCall call) {
        String functionName = call.getName();
        LogicalExpression nameArg = call.args.get(0);
        LogicalExpression valueArg = call.args.size() == 2 ? call.args.get(1)
                : null;
        DrillParquetCompareFunctionProcessor evaluator = new DrillParquetCompareFunctionProcessor(
                functionName);
    ...
    public DrillParquetCompareFunctionProcessor(String functionName) {
        this.success = false;
