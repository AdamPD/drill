...
public interface ExecConstants {
  ...
  String PARQUET_ENABLE_PUSHDOWN_FILTER = "store.parquet.enable_pushdown_filter";
  OptionValidator PARQUET_ENABLE_PUSHDOWN_FILTER_IMPLEMENTATION_VALIDATOR = new BooleanValidator(PARQUET_ENABLE_PUSHDOWN_FILTER, false);
